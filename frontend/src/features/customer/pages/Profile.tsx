  ...
  return (
    <div className="w-full min-h-screen bg-[var(--color-background)] pt-16 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="font-serif text-3xl text-[var(--color-primary)] mb-8">Hồ Sơ Có Nhân</h1>
              ...
              <div className="space-y-6 animate-in fade-in duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-1 md:col-span-2">
                    ...
                    />
                    <p className="text-xs text-[var(--color-primary)]/40 mt-1 italic">Email không thể thay đổi sau khi đăng k?.</p>
                  </div>
                  <div className="space-y-1 md:col-span-2">
