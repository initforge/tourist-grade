...
<h3 className="text-[10px] uppercase tracking-widest font-bold text-[#2A2421]/40 mb-6">Cấu hành Giá</h3>
...
<h3 className="text-[10px] uppercase tracking-widest font-bold text-[#2A2421]">Nhật k? trao đổi</h3>
</div>
...
<p>Đã cập nhật lại giá theo phụ lục số 03 k? ngày 10/05 ạ?.</p>
</div>
</div>
</div>
