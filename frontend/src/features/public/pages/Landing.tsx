        ...
        <div className="public-container relative z-10 public-hero">
          <div className="public-copy-width">
            ...
            <p className="mt-5 text-sm md:text-base text-white/85 leading-relaxed max-w-2xl">
              Chọn hành trình phù hợp, xem lịch khởi hành đang mở bán và đặt tour nhanh trên cùng một luồng rõ ràng, gọn gàng.
            </p>
          </div>

          <div className="public-floating-card mt-8 md:mt-10 p-3 md:p-4 max-w-4xl">
      ...
      <section className="public-section bg-surface">
        <div className="public-container">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
            <div>
              <span className="text-secondary font-serif italic text-xl mb-3 block">Gợi ý nổi bật</span>
