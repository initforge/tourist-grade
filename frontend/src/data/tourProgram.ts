...
export const mockTourPrograms: TourProgram[] = [
  ...
  },
  {
    ...
    status: 'active',
    itinerary: [
      { day: 1, title: 'Hà Nội - Osaka', description: 'Bay đến Osaka Kansai. Đón và đưa về khách sạn.', meals: ['lunch'] },
      { day: 2, title: 'Khám phá Osaka', description: 'Lâu đài Osaka và Dotonbori.', meals: ['breakfast', 'dinner'] },
      { day: 3, title: 'Cố đô Kyoto', description: 'Chùa Vàng, Kimono, Trà đạo.', meals: ['breakfast', 'lunch', 'dinner'] },
      { day: 4, title: 'Rừng trúc Arashiyama', description: 'Đi dạo rừng trúc và Kaiseki.', meals: ['breakfast', 'lunch', 'dinner'] },
      { day: 5, title: 'Nara', description: 'Công viên hươu Nara và Shinsaibashi.', meals: ['breakfast', 'lunch'] },
      { day: 6, title: 'Osaka - Hà Nội', description: 'Onsen và về Hà Nội.', meals: ['breakfast'] },
    ],
    pricingConfig: {
      profitMargin: 18,
      taxRate: 10,
