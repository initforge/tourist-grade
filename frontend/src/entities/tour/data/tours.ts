...
export const mockTours: Tour[] = [
  {
    ...
    exclusions: ['Chi phí có nhân, đồ uống ngoài thực đơn', 'Tiền tip cho hướng dẫn viên và l?i xe', 'VAT nếu yêu cầu xuất hóa đơn'],
  ...
  },
  {
    ...
    itinerary: [
      ...
      { day: 3, title: 'Thiền định và tĩnh tìm', description: 'Lớp Yoga riêng với thiền sư?. Trekking đỉnh núi Vườn Quốc Gia Núi Chúa?.', activities: ['Yoga thiền định', 'Trekking đỉnh núi'], meals: ['breakfast', 'lunch', 'dinner'] },
    ...
    inclusions: ['Xe đưa đ?n sân bay Cam Ranh', '03 đêm tại biệt thự Amanoi', 'Bữa ăn theo chương trình', 'Liệu trình Spa 60 phút/ngày', 'Du thuyền Vịnh Vĩnh Hy', 'Bảo hiểm du lịch'],
    exclusions: ['Vé máy bay đến Cam Ranh', 'Chi phí có nhân, đồ uống ngoài thực đơn', 'VAT nếu yêu cầu'],
  ...
  },
  {
    ...
    description: 'Hành trình 6 ngày khám phá cố đô Kyoto trong sắc l? phong đỏ rực, thưởng thức Kaiseki chuẩn sao Michelin?.',
    ...
    inclusions: ['Vé máy bay khứ hồi NRT/KIX', '05 đ?m khách sạn 4* (phòng đôi)', 'Bữa ăn theo chương trình', 'Xe tham quan', 'Phí vào cửa các điểm tham quan', 'Hướng dẫn viên tiếng Việt', 'Bảo hiểm du lịch quốc tế'],
    exclusions: ['Chi phí có nhân, đồ uống ngoài thực đơn', 'Tip cho HDV và l?i xe (khoảng 50 USD)', 'Phí phòng đơn (nếu có)', 'VAT'],
