...
export const mockTourPrograms: TourProgram[] = [
  ...
  },
  {
    ...
    status: 'active',
    itinerary: [
      { day: 1, title: 'Hà Nội - Osaka', description: 'Bay đến Osaka Kansai?. Đón và đưa về khách sạn trung tìm Namba?.', meals: ['lunch'] },
  ...
  },
  {
    ...
    departurePoint: 'Hà Nội',
    sightseeingSpots: ['Sapa', 'Bản Cót Cót', 'Núi Hàm Rồng'],
