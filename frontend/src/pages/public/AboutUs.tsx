  ...
  return (
    <div className="w-full bg-[var(--color-background)]">
      ...
      <section className="relative h-[600px] w-full flex items-center justify-center overflow-hidden">
        <img 
          src="https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=2600" 
          alt="Luxury Resort" 
        ...
        <div className="relative z-10 w-full max-w-4xl px-6 text-center text-white">
          ...
          <h1 className="font-serif text-5xl md:text-7xl mb-8 tracking-tight">Vẻ Đẹp Đích Thực <br/> Của Đông Dương</h1>
          <p className="text-lg md:text-xl font-light opacity-90 leading-relaxed max-w-2xl mx-auto">
            Tại Travela, chúng tôi không chỉ tạo ra những chuyến đi, mà chúng tôi kiến tạo những trải nghiệm độc bản, tinh tế và mang đậm dấu ấn cá nhân giữa lòng tinh hoa di sản.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6 md:px-12 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <h2 className="font-serif text-3xl text-[var(--color-primary)]">Hành Trình Kiến Tạo <br/>Sự Khác Biệt</h2>
            ...
            <p className="text-[var(--color-primary)]/70 leading-relaxed text-sm">
              Chúng tôi tin rằng sự sang trọng không chỉ nằm ở những khách sạn 5 sao hay những dịch vụ xa xỉ, mà còn nằm ở những cảm xúc chân thực, sự tỉ mỉ trong từng chi tiết và khả năng chạm đến những giá trị nguyên bản nhất của mỗi vùng đất.
            </p>
          </div>
          <div className="relative">
            <div className="absolute inset-0 bg-[var(--color-surface)] translate-x-4 -translate-y-4"></div>
            <img 
      ...
      <section className="py-24 bg-[var(--color-surface)]">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="font-serif text-3xl text-[var(--color-primary)] mb-16">Giá Trị Cốt Lõi</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            
            <div className="bg-white p-10 border border-[#D0C5AF]/30 shadow-sm relative overflow-hidden group hover:-translate-y-2 transition-transform duration-300">
              ...
              <p className="text-sm text-[var(--color-primary)]/60 leading-relaxed">
                Mỗi hành trình là một tác phẩm nghệ thuật trọn vẹn, được "may đo" riêng biệt cho từng thượng khách để tôn vinh sở thích và phong cách sống.
              </p>
            </div>
            ...
            <div className="bg-white p-10 border border-[#D0C5AF]/30 shadow-sm relative overflow-hidden group hover:-translate-y-2 transition-transform duration-300">
              ...
              <p className="text-sm text-[var(--color-primary)]/60 leading-relaxed">
                Đội ngũ chuyên gia kiến thức sâu rộng không chỉ là hướng dẫn viên, mà còn là những người bạn đồng hành truyền cảm hứng.
              </p>
            </div>
            ...
            <div className="bg-white p-10 border border-[#D0C5AF]/30 shadow-sm relative overflow-hidden group hover:-translate-y-2 transition-transform duration-300">
              ...
              <p className="text-sm text-[var(--color-primary)]/60 leading-relaxed">
                Cam kết bảo tồn văn hóa di sản và thiên nhiên, mang lại những tác động tích cực và lâu dài cho cộng đồng địa phương.
              </p>
            </div>
      ...
      <section className="py-24 max-w-5xl mx-auto px-6 text-center">
         <h2 className="font-serif text-2xl text-[var(--color-primary)] mb-12">Chứng Nhận Danh Giá</h2>
