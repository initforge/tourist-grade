...
import type { TourProgram } from '../../data/tourProgram';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white w-full max-w-sm mx-4 shadow-2xl border border-[#D0C5AF]/30 p-8">
        ...
        <h3 className="font-['Noto_Serif'] text-xl text-[#2A2421] text-center mb-2">Từ chối chương trình tour</h3>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white w-full max-w-sm mx-4 shadow-2xl border border-[#D0C5AF]/30 p-8">
        ...
        <h3 className="font-['Noto_Serif'] text-xl text-[#2A2421] text-center mb-2">Duyệt chương trình tour</h3>
