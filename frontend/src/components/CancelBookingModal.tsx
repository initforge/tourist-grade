...
export function CancelBookingModal({ booking, onClose }: CancelBookingModalProps) {
  ...
  if (isSuccess) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-md bg-white shadow-2xl animate-in zoom-in-95 duration-300 p-8 text-center space-y-5">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg bg-white shadow-2xl animate-in zoom-in-95 duration-300 overflow-y-auto max-h-[90vh]">
        <div className="p-8">
          {/* Header */}
