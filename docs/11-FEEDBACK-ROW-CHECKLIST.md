...
| 38 | Coordinator | `-` | `/coordinator/services` | [ServiceList.tsx](/P:/tourist-grade/frontend/src/features/coordinator/pages/ServiceList.tsx:1) | [coordinator.spec.ts](/P:/tourist-grade/frontend/tests/coordinator.spec.ts:295), [coordinator-remaining.spec.ts](/P:/tourist-grade/frontend/tests/coordinator-remaining.spec.ts:176) | `Đáp ứng` | Không có attachment nhưng UI/test cover đủ; màn sửa đã có toggle chỉnh `Trạng thái`. |
| 39 | Coordinator | [row-39-B39.jpg](/P:/tourist-grade/docs/attachment-audit/row-39-B39.jpg) | `/coordinator/suppliers` | [Suppliers.tsx](/P:/tourist-grade/frontend/src/features/coordinator/pages/Suppliers.tsx:1) | [coordinator.spec.ts](/P:/tourist-grade/frontend/tests/coordinator.spec.ts:276), [coordinator-remaining.spec.ts](/P:/tourist-grade/frontend/tests/coordinator-remaining.spec.ts:176) | `Đáp ứng` | Supplier split đã mở trực tiếp attachment; màn thêm mới đã có `Đơn giá` cho dịch vụ ăn khách sạn/nhà hàng và màn sửa vận chuyển giữ expand bảng giá. |
