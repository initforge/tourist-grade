...
| 13 | Sales / Coordinator / Manager | `-` | `/sales/dashboard`, `/coordinator/dashboard`, `/manager/dashboard` | [SalesDashboard.tsx](/P:/tourist-grade/frontend/src/features/sales/pages/SalesDashboard.tsx:1), [CoordinatorDashboard.tsx](/P:/tourist-grade/frontend/src/features/coordinator/pages/CoordinatorDashboard.tsx:1), [ManagerDashboard.tsx](/P:/tourist-grade/frontend/src/features/manager/pages/ManagerDashboard.tsx:1), [DailyRevenueLineChart.tsx](/P:/tourist-grade/frontend/src/shared/ui/DailyRevenueLineChart.tsx:1) | [sales-dashboard.spec.ts](/P:/tourist-grade/frontend/tests/sales-dashboard.spec.ts:5), [dashboard-feedback.spec.ts](/P:/tourist-grade/frontend/tests/dashboard-feedback.spec.ts:5), [dashboard-feedback.spec.ts](/P:/tourist-grade/frontend/tests/dashboard-feedback.spec.ts:26), [dashboard-charts.spec.ts](/P:/tourist-grade/frontend/tests/dashboard-charts.spec.ts:1) | `Đáp ứng` | Cả 3 dashboard đều tách work/report đúng spec và `Báo cáo doanh thu theo ngày` đã hiển thị bằng line chart. |
...
| 32 | Coordinator | [row-32-B32.jpg](/P:/tourist-grade/docs/attachment-audit/row-32-B32.jpg) | `/coordinator/tour-rules` | [TourGenerationRules.tsx](/P:/tourist-grade/frontend/src/features/coordinator/pages/TourGenerationRules.tsx:1) | [coordinator-remaining.spec.ts](/P:/tourist-grade/frontend/tests/coordinator-remaining.spec.ts:84) | `Đáp ứng` | Bảng và popup tạo tour khớp attachment; popup `Sửa yêu cầu chờ duyệt bán` cũng đã đổi sang layout kiểu `Sinh tour` với khoảng ngày, preview nhiều dòng, giá bán, hạn đặt tour và checkbox tạo. |
...
| 38 | Coordinator | `-` | `/coordinator/services` | [ServiceList.tsx](/P:/tourist-grade/frontend/src/features/coordinator/pages/ServiceList.tsx:1) | [coordinator.spec.ts](/P:/tourist-grade/frontend/tests/coordinator.spec.ts:295), [coordinator-remaining.spec.ts](/P:/tourist-grade/frontend/tests/coordinator-remaining.spec.ts:176) | `Đáp ứng` | Form thêm mới đã có `Tên nhà cung cấp`, `Thông tin liên hệ`, `Đơn giá`; dịch vụ khác đổi sang dropdown công thức với nhánh `Giá trị mặc định` cho nhập số mặc định. |
| 39 | Coordinator | [row-39-B39.jpg](/P:/tourist-grade/docs/attachment-audit/row-39-B39.jpg) | `/coordinator/suppliers` | [Suppliers.tsx](/P:/tourist-grade/frontend/src/features/coordinator/pages/Suppliers.tsx:1) | [coordinator.spec.ts](/P:/tourist-grade/frontend/tests/coordinator.spec.ts:276), [coordinator-remaining.spec.ts](/P:/tourist-grade/frontend/tests/coordinator-remaining.spec.ts:176) | `Đáp ứng` | Nút `Thêm bảng giá` của khách sạn/nhà hàng được đưa ra ngoài bảng dịch vụ; phần expand chỉ còn vai trò xem bảng giá. |
...
| 42 | Manager | `-` | `/manager/tour-programs/TP003/approval`, `/manager/tour-programs/TP001` | [AdminTourProgramApproval.tsx](/P:/tourist-grade/frontend/src/features/manager/pages/AdminTourProgramApproval.tsx:1), [TourProgramDetail.tsx](/P:/tourist-grade/frontend/src/features/manager/pages/TourProgramDetail.tsx:1), [TourProgramDetailScreen.tsx](/P:/tourist-grade/frontend/src/features/coordinator/components/TourProgramDetailScreen.tsx:1) | [manager-remaining.spec.ts](/P:/tourist-grade/frontend/tests/manager-remaining.spec.ts:70), [manager-remaining.spec.ts](/P:/tourist-grade/frontend/tests/manager-remaining.spec.ts:123) | `Đáp ứng` | Approval screen read-only theo form tạo mới 4 bước; màn detail manager active dùng chung layout coordinator và tab `Giá & Cấu hình` bỏ cột `Thao tác` ở chế độ chỉ xem. |
...
| 44 | Manager | `-` | `/manager/tour-programs` | [TourPrograms.tsx](/P:/tourist-grade/frontend/src/features/manager/pages/TourPrograms.tsx:1) | [manager-remaining.spec.ts](/P:/tourist-grade/frontend/tests/manager-remaining.spec.ts:111) | `Đáp ứng` | Tab active mở sang màn detail manager dùng layout chi tiết chuẩn thay cho modal rút gọn cũ. |
...
- GitHub `main` đã được push lại thành công; Cloudflare Pages là kênh deploy frontend chuẩn để đối chiếu nhanh ngoài local stack.
