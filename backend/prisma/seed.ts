...
async function main() {
  ...
  const publicTours = [
    ...
    },
    {
      ...
      category: 'domestic',
      itinerary: [
        { day: 1, title: 'Sân bay Cam Ranh - Amanoi', description: 'Check-in biệt thự nghỉ dưỡng.', activities: ['Check-in'], meals: ['lunch', 'dinner'] },
        { day: 2, title: 'Hành trình nước', description: 'Du thuyền riêng và snorkeling.', activities: ['Du thuyền', 'Snorkeling'], meals: ['breakfast', 'lunch', 'dinner'] },
        { day: 3, title: 'Tĩnh tại', description: 'Yoga và trekking nhẹ.', activities: ['Yoga', 'Trekking'], meals: ['breakfast', 'lunch', 'dinner'] },
        { day: 4, title: 'Tạm biệt', description: 'Trả phòng và ra sân bay.', activities: ['Trả phòng'], meals: ['breakfast'] },
      ],
    ...
    },
    {
      ...
      itinerary: [
        { day: 1, title: 'Hà Nội - Osaka', description: 'Bay thẳng đến Osaka.', activities: ['Nhận phòng'], meals: ['lunch'] },
        { day: 2, title: 'Khám phá Osaka', description: 'Tham quan lâu đài Osaka.', activities: ['Lâu đài Osaka', 'Dotonbori'], meals: ['breakfast', 'dinner'] },
        { day: 3, title: 'Cố đô Kyoto', description: 'Thăm Kinkakuji và trải nghiệm trà đạo.', activities: ['Kinkakuji', 'Trà đạo'], meals: ['breakfast', 'lunch', 'dinner'] },
        { day: 4, title: 'Arashiyama', description: 'Rừng trúc và bữa tối Kaiseki.', activities: ['Rừng trúc', 'Kaiseki'], meals: ['breakfast', 'lunch', 'dinner'] },
        { day: 5, title: 'Nara', description: 'Công viên hươu và mua sắm.', activities: ['Nara', 'Mua sắm'], meals: ['breakfast', 'lunch'] },
        { day: 6, title: 'Osaka - Hà Nội', description: 'Onsen sáng và kết thúc hành trình.', activities: ['Onsen'], meals: ['breakfast'] },
      ],
      departurePoint: 'Hà Nội',
      ...
      inclusions: ['Vé máy bay', 'Khách sạn 4 sao', 'Ăn theo chương trình', 'Bảo hiểm'],
  ...
  const instances = await Promise.all([
    ...
    prisma.tourInstance.create({
      data: {
        ...
        programId: tp1.id,
        programNameSnapshot: tp1.name,
        departureDate: toDate('2026-05-20'),
        bookingDeadlineAt: toDate('2026-05-13T23:59:59+07:00'),
        status: 'DANG_MO_BAN',
        departurePoint: 'Hà Nội',
        sightseeingSpots: ['Quảng Ninh'],
        transport: 'XE',
        ...
        createdById: coordinator.id,
        approvedById: manager.id,
        submittedAt: toDate('2026-04-20T10:00:00Z'),
        approvedAt: toDate('2026-04-21T10:00:00Z'),
        openedAt: toDate('2026-04-22T00:00:00Z'),
      },
    }),
  ]);
